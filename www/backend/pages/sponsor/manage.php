<div class="container-fluid">
    <div class="row page-head">
        <div class="col-6 p-0">
            <h1><i class="fa fa-fw fa-ticket op-2"></i> Gestione Sponsor</h1>
        </div>
        <?php
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-inline">
                                                            <input class="form-control custom-render" type="file" name="Images[]" accept="image/*" multiple fileUpload fileUploadType="<?= Base_Files_Upload_Type::ON_CHANGE ?>" fileMacro="<?= Base_Files::SPONSOR ?>" fileType="<?= Base_Files_Types::IMAGE ?>" onclick="uploadManager('Images[]')" callback="getFilesManager('dtContents', <?= Base_Files::SPONSOR ?>, <?= Base_Files_Types::IMAGE ?>)" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
            ...
            <div class="card mb-3 shadow">
                ...
                <div class="card-footer">
                    <div class="row align-items-center">
                        <div class="col-6">
                            <button type="button" class="btn btn-sm btn-link text-danger" onclick="simpleDelete(<?= Base_Simple_Delete::SPONSOR ?>)">
                                <i class="fas fa-trash"></i> Elimina
                            </button>
                        </div>
                        <div class="col-6 text-end">
                            <button type="button" class="btn btn-success" onclick="saveSponsor()">
